...
public partial class Vehicles
{
    ...
    public virtual VehicleBodyType VehicleBodyCodeNavigation { get; set; }

    public virtual ICollection<VehicleSpecification> VehicleSpecification { get; set; } = new List<VehicleSpecification>();
}